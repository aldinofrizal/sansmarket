  ...
  actions: {
    login(context, payload) {
      return new Promise(function (resolve, reject) {
        Axios({
          method: 'post',
          url: 'http://34.87.23.81/user/login',
          data: payload
        })
          .then(({ data }) => {
    ...
    register(context, payload) {
      return new Promise(function (resolve, reject) {
        Axios({
          method: 'post',
          url: 'http://34.87.23.81/user/register',
          data: payload,
        })
          .then(({ data }) => {
            resolve(data)
    ...
    deleteProduct(context, payload) {
      return new Promise(function (resolve, reject) {
        Axios({
          method: 'delete',
          url: `http://34.87.23.81/product/${payload._id}`,
          headers: { token: localStorage.getItem('token') },
          data: payload
        })
          .then(({ data }) => {
    ...
    patchProduct(context, payload) {
      return new Promise(function (resolve, reject) {
        Axios({
          method: 'patch',
          url: `http://34.87.23.81/product/${payload.id}`,
          headers: { token: localStorage.getItem('token') },
          data: payload.data
        })
          .then(({ data }) => {
    ...
    addToCart(context, payload) {
      return new Promise(function (resolve, reject) {
        Axios({
          method: 'patch',
          url: 'http://34.87.23.81/user/addToCart',
    ...
    removeFromCart(context, payload) {
      return new Promise(function (resolve, reject) {
        ...
        Axios({
          method: 'patch',
          url: 'http://34.87.23.81/user/removeFromCart',
          headers: { token: localStorage.getItem('token') },
      ...
      Axios({
        ...
        .then(response => {
          return new Promise(function (reslove, reject) {
            Axios({
              method: 'patch',
              url: 'http://34.87.23.81/user/checkout',
              headers: { token: localStorage.getItem('token') }
            })
              .then(({ data }) => {
                reslove(data)
    ...
    fetchTransaction(context, payload){
      Axios({
        method : 'get',
        url : 'http://34.87.23.81/transaction',
        headers : { token : localStorage.getItem('token')}
      })
      .then( ({data}) => {
    ...
    confirmTransaction(context,payload){
      return new Promise(function(resolve,reject){
        Axios({
          method : 'patch',
          url : `http://34.87.23.81/transaction/${payload}`,
          headers : { token : localStorage.getItem('token')}
        })
        .then( ({data}) => {
          resolve(data)
    ...
    userTransaction(context,payload){
      return new Promise(function(resolve,reject){
        Axios({
          method : 'get',
          url : 'http://34.87.23.81/transaction/user',
          headers : { token : localStorage.getItem('token')}
        })
        .then( ({data}) => {
          resolve(data)
